...
export default function Offers() {
  ...
  const handleCopy = async (cuponCode: string) => {
    ...
    Toast.show({
      ...
      text2:
        "Agora é só colar no site da loja parceira e aproveitar o desconto!",
    })
  ...
  return (
    <View className="flex-1 bg-zinc-800">
      ...
      <View className="flex-1 px-6 gap-3">
        <View className="w-72">
          <Text className="text-white text-3xl font-roboto-semibold">
            Ofertas
          </Text>
          <Text
          ...
          >
            Utilize um de nossos cupons de desconto em nossas lojas parceiras,
            economizando ainda mais em seus pedidos!
          </Text>
        </View>
        <FlatList
          data={offers}
              ...
              >
                <View className="mr-auto">
                  <View>
                    ...
                    <Text className="text-xs text-white">
                      {offer.footer ?? "Cupom de desconto"}
                    </Text>
                  </View>
                  <TouchableOpacity
