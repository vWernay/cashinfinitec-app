            ...
            renderItem={({ item: product }) => (
              <View className="flex-row bg-white rounded-xl">
                ...
                <View className="flex-1 flex-row ml-4 p-3 bg-zinc-300 rounded-tr-xl rounded-br-xl">
                  <View className="w-48">
                    <Text className="text-base font-semibold text-zinc-900 uppercase">
                      {product.title}
                    </Text>
                    <Text className="text-sm text-zinc-600 uppercase mb-2">
                      {product.discount}% de desconto com bônus
                    </Text>
